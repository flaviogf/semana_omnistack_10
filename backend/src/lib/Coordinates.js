class Coordinates {
  isNear({ source, target, maxDistance = 10 }) {
    return this._getDistanceFromLatLonInKm(source, target) <= maxDistance
  }

  _getDistanceFromLatLonInKm(centerCoordinates, pointCoordinates) {
    const radius = 6371
